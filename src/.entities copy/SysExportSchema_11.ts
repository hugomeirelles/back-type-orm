...
@Index("SYS_C00269855", ["processOrder", "duplicate"], { unique: true })
@Index(
  "SYS_MTABLE_00002B9F2_IND_1",
  ["objectSchema", "originalObjectName", "objectType"],
  {}
)
@Index(
  "SYS_MTABLE_00002B9F2_IND_2",
  [
    "objectSchema",
    "objectName",
    "objectType",
...
@Index("SYS_MTABLE_00002B9F2_IND_3", ["baseProcessOrder"], {})
@Index(
  "SYS_MTABLE_00002B9F2_IND_4",
  ["originalObjectSchema", "originalObjectName", "partitionName"],
  {}
)
@Index("SYS_MTABLE_00002B9F2_IND_5", ["seed"], {})
@Entity("SYS_EXPORT_SCHEMA_11")
export class SysExportSchema_11 {
