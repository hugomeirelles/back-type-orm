...
@Index(
  "PK_TBL_DOSSIE_SERVICO_PROCESSO",
  ["codDossieConfiguracao", "codAssuntoDocumentoTipo"],
  { unique: true }
)
@Entity("TBL_DOSSIE_SERVICO_PROCESSO")
export class TblDossieServicoProcesso {
  ...
  @ManyToOne(
    ...
    (tblDossieConfiguracao) => tblDossieConfiguracao.tblDossieServicoProcessos
  )
  @JoinColumn([
    {
  ...
  @ManyToOne(
    ...
    (tblAssuntoDocumentoTipo) =>
      tblAssuntoDocumentoTipo.tblDossieServicoProcessos
  )
  @JoinColumn([
    {
