...
@Index("SYS_C00269897", ["processOrder", "duplicate"], { unique: true })
@Index(
  "SYS_MTABLE_000026708_IND_1",
  ["objectSchema", "originalObjectName", "objectType"],
  {}
)
@Index(
  "SYS_MTABLE_000026708_IND_2",
  [
    "objectSchema",
    "objectName",
    "objectType",
...
@Index("SYS_MTABLE_000026708_IND_3", ["baseProcessOrder"], {})
@Index(
  "SYS_MTABLE_000026708_IND_4",
  ["originalObjectSchema", "originalObjectName", "partitionName"],
  {}
)
@Index("SYS_MTABLE_000026708_IND_5", ["seed"], {})
@Entity("SYS_EXPORT_SCHEMA_03")
export class SysExportSchema_03 {
