...
@Index("SYS_C00269754", ["processOrder", "duplicate"], { unique: true })
@Index(
  "SYS_MTABLE_000030D94_IND_1",
  ["objectSchema", "originalObjectName", "objectType"],
  {}
)
@Index(
  "SYS_MTABLE_000030D94_IND_2",
  [
    "objectSchema",
    "objectName",
    "objectType",
...
@Index("SYS_MTABLE_000030D94_IND_3", ["baseProcessOrder"], {})
@Index(
  "SYS_MTABLE_000030D94_IND_4",
  ["originalObjectSchema", "originalObjectName", "partitionName"],
  {}
)
@Index("SYS_MTABLE_000030D94_IND_5", ["seed"], {})
@Entity("SYS_EXPORT_SCHEMA_14")
export class SysExportSchema_14 {
