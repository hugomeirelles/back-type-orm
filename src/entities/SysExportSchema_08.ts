...
@Index("SYS_C00269556", ["processOrder", "duplicate"], { unique: true })
@Index(
  "SYS_MTABLE_0000283DB_IND_1",
  ["objectSchema", "originalObjectName", "objectType"],
  {}
)
@Index(
  "SYS_MTABLE_0000283DB_IND_2",
  [
    "objectSchema",
    "objectName",
    "objectType",
...
@Index("SYS_MTABLE_0000283DB_IND_3", ["baseProcessOrder"], {})
@Index(
  "SYS_MTABLE_0000283DB_IND_4",
  ["originalObjectSchema", "originalObjectName", "partitionName"],
  {}
)
@Index("SYS_MTABLE_0000283DB_IND_5", ["seed"], {})
@Entity("SYS_EXPORT_SCHEMA_08")
export class SysExportSchema_08 {
